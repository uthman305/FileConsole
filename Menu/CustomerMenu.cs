    ...
    public class CustomerMenu
    {
        ...
        public void DepositMenu()
        {
            try
            {
                ...
                var deposit = depositManager.Make(accountNumber, accountNumber, amount, pin);
                if (deposit == null)
                {
                    Console.WriteLine("Account does not exist or you entered a wrong value");
                    CustomerMain();
                }
                else
                {
        ...
        public void PurchaseMenu()
        {
            try
            {
                ...
                var purchase = purchaseManager.Make(accountNumber, accountNumber, agentId, amount, pin);
                ...
                {
                    var customer = customerManager.Get(purchase.UserId);
